...
{
    public partial class fRepSumByWaiter : Form
    {
        DBaccess dbAccess = new DBaccess();
        Filter oFilter = new Filter();

        public fRepSumByWaiter()
        {
            InitializeComponent();
        }

        private void fRepSumByWaiter_Shown(object sender, EventArgs e)
        {
        ...
        private void showReport()
        {
            ...
            pathForReport = Environment.CurrentDirectory + @"\reports\byWaiterSum.rpt";
