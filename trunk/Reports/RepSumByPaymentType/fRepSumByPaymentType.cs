...
{
    public partial class fRepSumByPaymentType : Form
    {
        DBaccess dbAccess = new DBaccess();
        Filter oFilter = new Filter();

        public fRepSumByPaymentType()
        {
            InitializeComponent();
        }

        private void fRepSumByPaymentType_Shown(object sender, EventArgs e)
        {
        ...
        private void showReport()
        {
            ...
            pathForReport = Environment.CurrentDirectory + @"\reports\byPaymentType.rpt";
